...
vi.mock("@/components/Common/blog-link", () => ({
  BlogLink: ({ ...props }) => <a data-testid="blog-link" href="https://zenn.dev/mitate_gengaku" {...props} />,
}));
...
describe("Blogセクションコンポーネント", () => {
  ...
  describe("articlesの個数が0の場合", () => {
    ...
    test("BlogLinkにはRead moreというテキストが表示され、hrefを持っていること", () => {
      ...
      expect(rendered.getByTestId("blog-link")).toHaveAttribute("href", "https://zenn.dev/mitate_gengaku")
    })
  });
});
